            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                ...
                <div className="pt-2">
                  ...
                  <div className="grid grid-cols-4 sm:grid-cols-4 lg:grid-cols-8 border border-[var(--text-secondary)]/20 divide-x divide-y lg:divide-y-0 divide-[var(--text-secondary)]/20">
